...
class SportzHub {
  ...
  async apiCall(endpoint, method = "GET", data = null) {
    ...
    // Use the mock API server running on port 3001
    ...
    try {
      ...
      // Fallback: try the PHP backend if mock server fails
      const currentPath = window.location.pathname;
      let fallbackApiBaseUrl = "";

      if (currentPath.includes("/admin/")) {
        fallbackApiBaseUrl = "../../backend/public/api/";
